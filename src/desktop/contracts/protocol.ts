...
export type DesktopEvent =
  ...
  | { type: "preview"; open: boolean; url?: string };
...
export const EngineQuerySchema = z.discriminatedUnion("kind", [
  ...
  z
    .object({
      ...
      goalId: z.string(),
      checkId: z.string(),
      confirmation: z.literal("PREVISUALIZAR"),
    })
    .strict(),
...
export function validSnapshot(value: unknown): value is UiSnapshot {
  ...
  return (
    ...
    [s.tasks, s.agents, s.activity, s.artifacts, s.checks].every(
...
export function parseRange(
  ...
  if (
    ...
    throw new Error("Rango no satisfacible");
