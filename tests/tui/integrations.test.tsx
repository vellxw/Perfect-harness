...
test("la aprobación muestra argumentos y conserva el digest, mientras un resultado incierto no se aprueba", () => {
  ...
  s.integrations = {
    connections: [], windows: [], pending: [{
      id: "op-1", serverId: "github", tool: "create_pull_request", digest: "exact-digest",
      state: "pending", effect: "write", role: "general", runId: "run-1", expiresAt: "2026-09-14T00:00:00Z",
      arguments: '{"owner":"vellxw","repo":"Perfect-harness","head":"perfect/fix"}',
    }],
  };
